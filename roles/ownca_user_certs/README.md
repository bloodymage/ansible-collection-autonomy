Ansible Role: Bloodymage.rebeldream.ownca_user_certs
===============
...
Description
-----------
Generates Certificates for realm users from the internal Certificate Authority
...
Including an example of how to use your role (for instance, with variables passed in as parameters) is always nice for users too:
    ...
    - hosts: servers
      roles:
        - { role: bloodymage.rebeldream.ownca_user_certs, x: 42 }
